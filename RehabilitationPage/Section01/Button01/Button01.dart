...
import 'package:ehssam01/pages/RehabilitationPage/Section01/Button01/Button01Controller.dart';
...
class Section01Button01Screen extends StatelessWidget {
  final controller = Get.put(Button01controller());
          ...
          Obx(
                () => Row(
                  ...
                  children: [
                    ...
                    FloatingActionButton(onPressed: (){Get.toNamed("SectionOne");},child: Icon(Icons.arrow_back),)
                  ],
                ),
          ),
        ],
