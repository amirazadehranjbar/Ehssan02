...
class Button10controller extends GetxController {
  ...
  void onInit() {
    ...
    Future.microtask(() async {
      await audioPlayer.setSource(AssetSource('DoubleDichoticDigits/List 12.wav')); // DoubleDichoticDigits/List 1.wav
    });
  }
