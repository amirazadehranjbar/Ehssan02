...
import 'Button04Controller.dart';
import 'Button04DigitsList.dart';
...
class DigitsTable extends StatelessWidget {
  ...
  final Button04controller controller;
                  ...
                  rows: List<DataRow>.generate(
                    25,
                      ...
                      cells: [
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button04DigitsList.EXTA01[index])),
                        DataCell(
                          Checkbox(
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button04DigitsList.EXTA02[index])),
                        DataCell(
                          Checkbox(
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button04DigitsList.EXTB01[index])),
                        DataCell(
                          Checkbox(
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button04DigitsList.EXTB02[index])),
                        DataCell(
                          Checkbox(
