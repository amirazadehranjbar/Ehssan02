...
class Section03Button05Screen extends StatelessWidget {
  final controller = Get.put(Button05controller());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(
        titleText: "جلسه 3_بخش 5",
          ...
          Obx(
                () => Row(
                  ...
                  children: [
                    ...
                    ResultWidget(textName: "ETX A B Percent :",textResults: "${controller.calculateCorrectEXTA02AnswersPercent().toInt()} %"),
