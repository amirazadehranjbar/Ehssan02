...
class Button05controller extends GetxController {
  ...
  void onInit() {
    ...
    Future.microtask(() async {
      await audioPlayer.setSource(AssetSource('DoubleDichoticDigits/List 10.wav')); // DoubleDichoticDigits/List 1.wav
    });
  }
