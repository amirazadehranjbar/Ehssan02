...
import 'Button09Controller.dart';
import 'Button09DigitsList.dart';
...
class DigitsTable extends StatelessWidget {
  ...
  final Button09controller controller;
                  ...
                  rows: List<DataRow>.generate(
                    25,
                      ...
                      cells: [
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button09DigitsList.EXTA01[index])),
                        DataCell(
                          Checkbox(
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button09DigitsList.EXTA02[index])),
                        DataCell(
                          Checkbox(
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button09DigitsList.EXTB01[index])),
                        DataCell(
                          Checkbox(
                        ...
                        ////////////////////////////////////////////////////////
                        DataCell(Text(Button09DigitsList.EXTB02[index])),
                        DataCell(
                          Checkbox(
