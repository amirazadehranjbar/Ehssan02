...
class Button09controller extends GetxController {
  ...
  void onInit() {
    ...
    Future.microtask(() async {
      await audioPlayer.setSource(AssetSource('DoubleDichoticDigits/List 11.wav')); // DoubleDichoticDigits/List 1.wav
    });
  }
