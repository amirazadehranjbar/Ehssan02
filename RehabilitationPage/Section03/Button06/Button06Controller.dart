...
class Button06controller extends GetxController {
  ...
  var EXTA01CheckboxStates = List<bool>.filled(15, false).obs;
  var EXTA02CheckboxStates = List<bool>.filled(15, false).obs;
  var EXTB01CheckboxStates = List<bool>.filled(15, false).obs;
  var EXTB02CheckboxStates = List<bool>.filled(15, false).obs;
  ...
  void onInit() {
    ...
    Future.microtask(() async {
      await audioPlayer.setSource(AssetSource('DoubleDichoticDigits/List 4.wav')); // DoubleDichoticDigits/List 1.wav
    });
  }
  ...
  double calculateCorrectEXTA01AnswersPercent() {
    return (calculateCorrectEXTA01Answers() / 15) * 100;
  }
  ...
  double calculateCorrectEXTA02AnswersPercent() {
    return (calculateCorrectEXTA02Answers() / 15) * 100;
  }
  ...
  double calculateCorrectEXTB01AnswersPercent() {
    return (calculateCorrectEXTB01Answers() / 15) * 100;
  }
  ...
  double calculateCorrectEXTB02AnswersPercent() {
    return (calculateCorrectEXTB02Answers() / 15) * 100;
  }
