...
class Button03controller extends GetxController {
  ...
  var EXTA01CheckboxStates = List<bool>.filled(32, false).obs;
  var EXTA02CheckboxStates = List<bool>.filled(32, false).obs;
  var EXTB01CheckboxStates = List<bool>.filled(32, false).obs;
  var EXTB02CheckboxStates = List<bool>.filled(32, false).obs;
  ...
  double calculateCorrectEXTA01AnswersPercent() {
    return (calculateCorrectEXTA01Answers() / 32) * 100;
  }
  ...
  double calculateCorrectEXTA02AnswersPercent() {
    return (calculateCorrectEXTA02Answers() / 32) * 100;
  }
  ...
  double calculateCorrectEXTB01AnswersPercent() {
    return (calculateCorrectEXTB01Answers() / 32) * 100;
  }
  ...
  double calculateCorrectEXTB02AnswersPercent() {
    return (calculateCorrectEXTB02Answers() / 32) * 100;
  }
