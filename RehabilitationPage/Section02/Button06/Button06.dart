...
import 'package:ehssam01/pages/RehabilitationPage/Section02/Button06/Button06Controller.dart';
...
class Section02Button06Screen extends StatelessWidget {
  final controller = Get.put(Button06controller());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(
        titleText: "جلسه 2_بخش 6",
