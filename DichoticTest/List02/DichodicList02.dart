...
import 'ControllerDichodic02.dart';
import 'WorldList02.dart';


class DichodicListTwoScreen extends StatelessWidget {
  final controller = Get.put(DichodicListOneController02());
                        ...
                        rows: List<DataRow>.generate(
                          25,
                            ...
                            cells: [
                              ...
                              DataCell(Text(WordList02.wordsLeft[index])),
                              DataCell(
                                Checkbox(
                              ...
                              DataCell(Text(WordList02.wordsRight[index])),
                              DataCell(
                                Checkbox(
