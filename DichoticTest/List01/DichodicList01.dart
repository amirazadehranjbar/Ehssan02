...
import 'DichodicListOneController.dart';
import 'WorldList01.dart';

class DichodicListOneScreen extends StatelessWidget {
  final controller = Get.put(DichodicListOneController());
                        ...
                        rows: List<DataRow>.generate(
                          ...
                          (index) => DataRow(
                            cells: [
                              ...
                              DataCell(Text(WordList.wordsLeft[index])),
                              DataCell(
                                Checkbox(
                              ...
                              DataCell(Text(WordList.wordsRight[index])),
                              DataCell(
                                Checkbox(
