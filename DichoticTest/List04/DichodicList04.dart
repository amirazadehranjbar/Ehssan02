...
import 'ControllerDichodic04.dart';
import 'WorldList04.dart';


class DichodicListFourScreen extends StatelessWidget {
  final controller = Get.put(DichodicListOneController04());
                        ...
                        rows: List<DataRow>.generate(
                          25,
                            ...
                            cells: [
                              ...
                              DataCell(Text(WordList04.wordsLeft[index])),
                              DataCell(
                                Checkbox(
                              ...
                              DataCell(Text(WordList04.wordsRight[index])),
                              DataCell(
                                Checkbox(
